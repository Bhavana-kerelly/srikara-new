  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FFF9FA] text-[#1A202C] selection:bg-[#8B1A4A] selection:text-white">
        ...
        {/* Clean Static Hero Section (No Scroll Hijack / Scrolling Canvas Effect) */}
        <section className="relative pt-32 lg:pt-40 pb-16 md:pb-24 overflow-hidden">
          {/* Ambient blur accents */}
          <div className="absolute top-[100px] left-1/2 -translate-x-1/2 w-[700px] h-[400px] rounded-full bg-[#8B1A4A]/10 blur-[130px] pointer-events-none" />
          <div className="absolute top-[250px] -right-[100px] w-[400px] h-[400px] rounded-full bg-[#2D3A4A]/5 blur-[120px] pointer-events-none" />
          ...
          <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-surface mb-6 shadow-sm border border-[#8B1A4A]/20"
            >
              <Star className="w-4 h-4 text-[#8B1A4A] fill-[#8B1A4A]" />
              <span className="text-[10px] font-black uppercase tracking-[0.25em] text-[#8B1A4A]">
                Discover Srikara Hospitals
              </span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="font-garamond text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.12] mb-6 text-[#1A202C]"
            >
              Pioneering Excellence in<br />
              <span className="text-[#8B1A4A] italic">Orthopedics & Multi-Specialty Care</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-[#4A4A4A] text-base sm:text-lg md:text-xl leading-relaxed font-light max-w-3xl mx-auto mb-10"
            >
              A legacy of clinical mastery, advanced robotic joint replacements, and patient-first compassionate healthcare delivered across 9 state-of-the-art hospitals in Telangana and Andhra Pradesh.
            </motion.p>
          </div>
        </section>
