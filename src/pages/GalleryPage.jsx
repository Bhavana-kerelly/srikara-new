...
// Dynamic photos from hospital-gallery folder
const GALLERY_FILES = ['gallery-1.jpg', 'gallery-2.jpg', 'gallery-3.jpg', 'gallery-4.jpg']

const PHOTOS = GALLERY_FILES.map((fileName, i) => ({
  src: assetUrl(`hospital-gallery/${fileName}`),
  category: i % 3 === 0 ? 'Infrastructure' : i % 3 === 1 ? 'Technology & OT' : 'Patient Care',
  caption: i % 3 === 0 ? 'World-class facilities at Srikara Hospitals'
    : i % 3 === 1 ? 'Advanced robotic & surgical technology'
