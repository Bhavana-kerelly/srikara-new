...
// Dynamic photos from public/hospital-gallery/ folder
// All 10 gallery images configured with categories & captions
const GALLERY_ITEMS = [
  { fileName: 'gallery-1.jpg', category: 'Infrastructure', caption: 'World-class facilities at Srikara Hospitals' },
  { fileName: 'gallery-2.jpg', category: 'Technology & OT', caption: 'Advanced robotic & surgical technology' },
  { fileName: 'gallery-3.jpg', category: 'Patient Care', caption: 'Compassionate care, every step of the way' },
  { fileName: 'gallery-4.jpg', category: 'Infrastructure', caption: 'Modern hospital architecture and patient amenities' },
  { fileName: 'gallery-5.jpg', category: 'Technology & OT', caption: 'State-of-the-art modular operation theater' },
  { fileName: 'gallery-7.jpg', category: 'Technology & OT', caption: 'Advanced robotic surgical suite & equipment' },
  { fileName: 'gallery-8.jpg', category: 'Patient Care', caption: 'Dedicated ICU and recovery monitoring ward' },
  { fileName: 'gallery-9.jpg', category: 'Infrastructure', caption: 'Patient reception and family waiting lounge' },
  { fileName: 'gallery-10.jpg', category: 'Infrastructure', caption: 'Celebration of leadership in robotic knee replacement' },
]

const PHOTOS = GALLERY_ITEMS.map((item, i) => ({
  src: assetUrl(`hospital-gallery/${item.fileName}`),
  category: item.category || (i % 3 === 0 ? 'Infrastructure' : i % 3 === 1 ? 'Technology & OT' : 'Patient Care'),
  caption: item.caption || 'Excellence in healthcare at Srikara Hospitals',
}))
