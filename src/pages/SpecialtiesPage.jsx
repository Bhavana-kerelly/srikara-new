  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-grow w-full flex flex-col justify-end mt-4">
        ...
        {/* Details Column - Restricted max-width when overlapping image is present */}
        <div className={`text-left flex flex-col justify-end h-full ${dept.organImage ? 'max-w-[65%]' : 'max-w-full'} pointer-events-none`}>
          ...
          <p className={`text-[12px] text-slate-500 font-medium leading-relaxed mb-4 ${dept.organImage ? 'max-w-[200px]' : 'max-w-full'}`}>
            {dept.desc}
          </p>
        ...
        {dept.organImage && (
          <div 
            className="absolute bottom-3 md:bottom-5 -right-2 w-[115px] md:w-[130px] flex justify-center items-center select-none pointer-events-none z-0"
          >
