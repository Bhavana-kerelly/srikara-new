...
const DEFAULT_BLOGS = BLOGS_DATA.map(b => ({
  id: String(b.id),
  category: b.category,
  ...
  status: 'Active',
  slug: b.slug,
  seoTitle: `${b.title} | Srikara Hospitals`,
  seoDesc: b.excerpt,
  readTime: b.readTime,
  image: b.image
}))
...
const DEFAULT_NEWS = [
  {
    id: '1',
    title: 'Srikara Hospitals is coming to Nellore',
    headline: 'Srikara Hospitals is coming to Nellore',
    type: 'Branch Announcement',
    category: 'Branch Announcement',
    date: '2026-08-10',
    content: 'A new Srikara Hospitals branch is coming soon to Nellore.',
    desc: 'A new Srikara Hospitals branch is coming soon to Nellore.',
    excerpt: 'A new Srikara Hospitals branch is coming soon to Nellore.',
    status: 'Active',
    showOnHomepage: true
  },
  {
    id: '2',
    title: 'A New Era of Robotic Surgery Begins — Advanced Robotic Care for Urology, General Surgery & Oncology at Lakdikapul & Miyapur, Hyderabad',
    headline: 'A New Era of Robotic Surgery Begins',
    type: 'Robotic Surgery',
    category: 'Robotic Surgery',
    date: '2026-08-14',
    content: 'Advanced Robotic Care for Urology, General Surgery & Oncology at Lakdikapul and Miyapur, Hyderabad.',
    desc: 'Advanced Robotic Care for Urology, General Surgery & Oncology at Lakdikapul and Miyapur, Hyderabad.',
    excerpt: 'Advanced Robotic Care for Urology, General Surgery & Oncology at Lakdikapul and Miyapur, Hyderabad.',
    status: 'Active',
    showOnHomepage: true
  }
]
...
const DEFAULT_PAGE_DATA = {
  ...
  branches: {
    ...
    'miyapur': { heroHeadline: "Multispecialty Care Hub", heroHighlight: "Advanced recovery.", description: "Trusted critical care, pediatrics, and neurology departments serving Miyapur.", phone: "040-68324805", address: "Main Road, Miyapur, Hyderabad - 500 049. India.", rating: 4.7, advantageTitle: "The Miyapur", advantageHighlight: "Advantage", infraTitle: "Precision", infraHighlight: "Ecosystem", infraDesc: "We invest in the future of healthcare so you can invest in your health." },
    'madeenaguda': { heroHeadline: "World-Class Care in Madeenaguda", heroHighlight: "Your Health Priority.", description: "Srikara Hospitals Madeenaguda brings multi-specialty clinical excellence, robotic joint replacement, and comprehensive emergency services to Miyapur-Madeenaguda.", phone: "040-68324803", address: "Mythri Nagar, Madinaguda, Miyapur, Hyderabad - 500 049. India.", rating: 4.8, advantageTitle: "The Madeenaguda", advantageHighlight: "Advantage", infraTitle: "Precision", infraHighlight: "Ecosystem", infraDesc: "We invest in the future of healthcare so you can invest in your health." },
...
export function AdminDashboard() {
  ...
  useEffect(() => {
    // Check Auth state
    if (!auth) {
      console.log('Firebase auth bypassed. Requiring login credentials.')
      setUser(null)
      setUserRole(null)
      setUserPermissions([])
  ...
  const saveNews = async (e) => {
    ...
    const payload = {
      ...
      desc: currentNews.content,
      excerpt: currentNews.content,
      date: currentNews.date || new Date().toISOString().slice(0, 10),
      createdAt: new Date().toISOString(),
      showOnHomepage: true
    }
    const originalNews = [...news]
    const updated = [payload, ...news.filter(n => String(n.id) !== newId)]
    ...
    try {
      window.dispatchEvent(new CustomEvent('srikara_news_updated'))
    } catch (_) {}
