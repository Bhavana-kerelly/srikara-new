    ...
    <>
      ...
      >
        ...
        >
          ...
          <NavLink to="/international-connentions" active={isActive('/international-connentions') || isActive('/international-connections') || isActive('/international-patients')} isWhite={isWhite}>
            <span className="hidden min-[1400px]:inline">International Connections</span>
            <span className="min-[1400px]:hidden">Intl Connections</span>
          </NavLink>
            ...
            >
              <nav className="flex flex-col gap-0.5 max-h-[60vh] overflow-y-auto custom-scrollbar">
                {[
                  ...
                  { label: 'International Connections', to: '/international-connentions' },
