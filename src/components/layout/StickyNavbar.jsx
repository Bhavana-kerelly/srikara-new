    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Specialties */}
          <NavLink to="/specialties" active={isActive('/specialties')} isWhite={isWhite}>
            Specialties
          </NavLink>
          ...
          <NavLink to="/international-connections" active={isActive('/international-connections')} isWhite={isWhite}>
