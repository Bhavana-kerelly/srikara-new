  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-grow w-full flex flex-col justify-end">
        ...
        <div className={`text-left flex flex-col justify-end h-full ${dept.organImage ? 'max-w-[65%] md:max-w-[70%]' : 'max-w-full'} relative z-10 pointer-events-none`}>
          <h3 className="font-display font-black text-slate-900 text-xl md:text-2xl leading-[1.05] uppercase tracking-tight mb-2.5">
            {dept.name}
          </h3>
          
          <p className={`text-[12px] text-slate-550 font-bold leading-snug mb-4 ${dept.organImage ? 'max-w-[280px]' : 'max-w-full'}`}>
            {dept.tagline}
          </p>
        ...
        {dept.imgOnRight && dept.organImage && (
          <div 
