    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mt-10 pt-8 border-t border-[#EDF2F7] flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button 
            onClick={() => {
              const msg = encodeURIComponent(`Hello Srikara Hospitals, I would like to book a specialist consultation regarding ${name} (${detail.specialist} Care).`);
              window.open(`https://wa.me/919247958308?text=${msg}`, '_blank');
            }}
            className="w-full md:w-auto bg-[#1A202C] text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-[#8B1A4A] transition-all flex items-center justify-center gap-3 group shadow-2xl text-sm cursor-pointer"
          >
