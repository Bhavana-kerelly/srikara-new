...
const CardCurtainRevealFooter = React.forwardRef(({ className, children, ...props }, ref) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("absolute inset-0 z-20 overflow-hidden pointer-events-none", className)}
...
const CardCurtainRevealTitle = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <motion.h3
      ref={ref}
      className={className}
      animate={isMouseIn ? { y: 0, opacity: 1 } : { y: 0, opacity: 1 }}
...
const CardCurtain = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn(
        "pointer-events-none absolute inset-0 size-full z-15",
        className
      )}
      variants={curtainVariants}
      animate={isMouseIn ? "visible" : "hidden"}
